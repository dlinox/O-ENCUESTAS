    ...
    <nav class="bg-gray-800">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <router-link to="/admin" aria-current="page"
                  class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">
                  Dashboard
                </router-link>

                <router-link to="/admin/surveys" class=" text-white rounded-md px-3 py-2 text-sm font-medium">
                  Encuesta
                </router-link>
                ...
                <a href="#"
                  class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Cinfiguraciones</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          ...
          <div class="mt-3 hidden space-y-1 px-2">
            <a href="#"
