<template>
  <ClientLayout>
    <template #header.title
      >FICHA INTEGRAL DEL ESTUDIANTE UNIVERSITARIO</template
    >
    <template #header.subtitle
      >Los datos a registrar son de carácter confidencial</template
    >

    <div class="grid grid-cols-4 gap-4">
      <div class="">
        <ul role="list" class="rounded-lg bg-white divide-y divide-gray-100">
          <li
            v-for="(item, index) in surveys"
            class="flex justify-between gap-x-6 p-3"
          >
            ...
            >
              <p class="mt-1 text-xs leading-5 text-gray-500">20 Preguntas</p>
            </div>
          </li>
        </ul>
      </div>
...
const surveys = [
  { title: "Precentacion", state: null },
  { title: "Encuesta 1", state: null },
  { title: "Encuesta 2", state: null },
];
